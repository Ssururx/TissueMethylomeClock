...
Downloaded and integrated four GEO datasets. Standardized age to decimal years, filtered for healthy controls only, and merged three blood studies into a unified cohort of 1,322 samples. This created a unified, well-annotated methylation cohort from heterogeneous GEO datasets.

### **Step 2: Quality Control & Exploration**

Implemented rigorous QC: removed samples with >5% missing values, verified beta-value ranges (0-1), and filtered 2 low-quality blood samples. PCA confirmed clear tissue separation. Data integrity is validated with minimal missing values (0.09% blood, 0% brain).

### **Step 3: Feature Discovery & Tissue Specificity**

Identified top age-associated CpGs: **38,707 significant in brain** (top r=0.936), **1,450 in blood** (top r=0.740). Developed Tissue Specificity Index (TSI) analyzing 250 shared CpGs: **60% tissue-locked**, **14% universal**, **26% intermediate**. These results suggest that most epigenetic aging signatures are tissue-specific rather than broadly conserved across tissues.
...
Mapped top 500 CpGs to genes: **363 unique brain genes**, **523 unique blood genes**, with only **13 genes shared**. **98.6% of brain genes and 96.6% of blood genes are unique** compared to Horvath/Hannum clocks. The minimal genetic overlap confirms tissue-specific aging programs.

### **Step 7: Pathway Analysis**

Brain genes enriched for **synaptic signaling and neuronal development**. Blood genes enriched for **immune response and inflammatory pathways**. We can conclude that aging engages in tissue-core functions: neural communication in brain, immune regulation in blood.

### **Step 8: Statistical Validation**

Passed rigorous bootstrap (500 iterations) and permutation testing (500 shuffles). Final correlations: **brain r=0.987, blood r=0.933** (p < 1e-100), which supports the fact that these models captured genuine biological signals.

### **Step 9: Comprehensive Genomic Context**

Extracted detailed genomic features: chromosomal location, CpG island status, gene region. **Chromosomes 1 and 19** show highest density of aging markers. Created streamlined datasets for top 500 CpGs. Which showed aging-associated CpGs distribute non-randomly across genome.

### **Step 10: DMR & Comparative Analysis**

Identified **472 DMRs in blood, 350 in brain**. Found fundamental difference: **blood aging targets promoter regions** (24.5% in TSS1500), while **brain aging targets gene bodies** (32.6%). These patterns point to distinct regulatory mechanisms of aging across tissues: promoter-associated regulation in blood and gene-body-associated processes in brain tissue.
